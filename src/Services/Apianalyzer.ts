...
export class ApiAnalyzer {
  ...
  private apiEndpointsarr: Array<ApiAnalysisResult>
  ...
  public analyzeApi(content: string, filePath: string): void {
  ...
  private extractApiEndpoints(content: string, filePath: string) {
  ...
  private extractApiEndpoints_regx(content: string, filePath: string) {
  ...
  private extractApiEndpoints_subEndPoints(content: string, filePath: string) {
  ...
  private GetRequestFlow(content: string) {
    ...
    const apiFunctionMatches = new Set<string>()
  ...
  public getApiCallingFunctions(): string[] {
    return Array.from(this.apiCallingFunctions)
  }

  public getErrorHandlingFunctions(): string[] {
